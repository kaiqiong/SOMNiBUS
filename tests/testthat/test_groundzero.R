...
test_that("all values in reference output, saved on disk, equals actual values coming from binomRegMethModel because both results were obtained using the same seed setting", {
