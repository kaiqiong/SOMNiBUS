...
$p_0 = 0.003$ and $p_1 = 0.9$ were estimated as the average incomplete or over conversion rates in the provided data. These two values coincide roughly with the incomplete and over conversion rates in a bisulfite sequencing experiment reported in @prochenka2015cautionary.
