...
```{r}
out = BSMethEM(data=RAdat.f, n.k = rep(5,3), p0 = 0.003, p1 = 0.9, Quasi = FALSE)
```
...
```{r}
time0 <- Sys.time()
out_quasi = BSMethEM(data=RAdat.f, n.k = rep(5,3), p0 = 0.003, p1 = 0.9, Quasi = TRUE)
...
time0<- Sys.time()
out_RA2 = BSMethEM(data=RAdat2, n.k = c(5,rep(max(3, round(nCpG/20)),9)), p0 = 0.003, p1 = 0.9, Quasi = TRUE)
print(Sys.time()-time0)
```
```{r}
out_RA2$reg.out
...
```{r}
time0<- Sys.time()
out_RA2_noError = BSMethEM(data=RAdat2, n.k = c(5,rep(max(3, round(nCpG/20)),9)), p0 = 0, p1 = 1, Quasi = TRUE)
print(Sys.time()-time0)
```
