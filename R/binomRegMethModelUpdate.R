...
#' will be used; in other words, whether a multiplicative dispersion
#' is added in the model or not.
...
#' \item \code{edf1} Effective degrees of freedom for each
#' smooth term in the model; tr(2A - A^2), where A is the
#' psuedo-hat matrix
#' \item \code{pearson_res} Pearson's residuals
#' \item \code{deviance_res} Deviance residuals
#' \item \code{edf} Effective degrees of freedom for each
#' smooth term in the model; tr(A)
#' \item \code{phi_fletcher} Fletcher-based dispersion
#' estimate
#' \item \code{GamObj} an updated Gam output
#' \item \code{E.S} expected methylated counts calculated
#' from the E step
#' }
...
binomRegMethModelUpdate <- function(data, pi.ij, p0, p1, n.k, binom.link,
    method, Z, my.covar.fm, Quasi = TRUE, scale, reml.scale) {
